...
const string MULT_R1 = "MULT_R1";
const string MULT_R1_C = "MULT_R1_C";
const string MULT_R2 = "MULT_R2";

const string MULTU_R1 = "MULTU_R1";
const string MULTU_R1_C = "MULTU_R1_C";
const string MULTU_R2 = "MULTU_R2";

const string DIV_R1 = "DIV_R1";
const string DIV_R1_C = "DIV_R1_C";
const string DIV_R2 = "DIV_R2";

const string DIVU_R1 = "DIVU_R1";
const string DIVU_R1_C = "DIVU_R1_C";
const string DIVU_R2 = "DIVU_R2";

const string LW_R1 = "LW_R1";
const string LW_R1_C = "LW_R1_C";
const string LW_R2I = "LW_R2I";
const string LW_LPAREN = "LW_LPAREN";
const string LW_R3 = "LW_R3";
const string LW_RPAREN = "LW_RPAREN";

const string SW_R1 = "SW_R1";
const string SW_R1_C = "SW_R1_C";
const string SW_R2I = "SW_R2I";
const string SW_LPAREN = "SW_LPAREN";
const string SW_R3 = "SW_R3";
const string SW_RPAREN = "SW_RPAREN";
...
const string MULT_ID = "mult";
const string MULTU_ID = "multu";
const string DIV_ID = "div";
const string DIVU_ID = "divu";
const string LW_ID = "lw";
const string SW_ID = "sw";
...
void output_lw_sw_type(int s, int t, int i, string type){
    int identity;
    if (LW_RPAREN == type) {
        identity = 140;
    }else{
...
void output_div_mult_type(int s, int t, string type){
    int identity;
    if (MULT_R2 == type) {
        identity = 24;
    }else if (MULTU_R2 == type){
        identity = 25;
    }else if (DIV_R2 == type){
        identity = 26;
    }else{
...
string getStateByCase(string id_value){
    ...
    if (JR_ID == id_value) {
        ...
        stateValue = MFHI_R1;
    }else if (MULT_ID == id_value){
        stateValue = MULT_R1;
    }else if (MULTU_ID == id_value){
        stateValue = MULTU_R1;
    }else if (DIV_ID == id_value){
        stateValue = DIV_R1;
    }else if (DIVU_ID == id_value){
        stateValue = DIVU_R1;
    }else if (LW_ID == id_value){
        stateValue = LW_R1;
    }else if (SW_ID == id_value){
        stateValue = SW_R1;
    }else{
...
int main(int argc, char* argv[]){
    ...
    stateMap.insert(state_value_type(state_token_key_type(MULT_R1, REGISTER), MULT_R1_C));
    stateMap.insert(state_value_type(state_token_key_type(MULT_R1_C, COMMA), MULT_R2));
    stateMap.insert(state_value_type(state_token_key_type(MULT_R2, REGISTER), START));
    
    stateMap.insert(state_value_type(state_token_key_type(MULTU_R1, REGISTER), MULTU_R1_C));
    stateMap.insert(state_value_type(state_token_key_type(MULTU_R1_C, COMMA), MULTU_R2));
    stateMap.insert(state_value_type(state_token_key_type(MULTU_R2, REGISTER), START));
    
    stateMap.insert(state_value_type(state_token_key_type(DIV_R1, REGISTER), DIV_R1_C));
    stateMap.insert(state_value_type(state_token_key_type(DIV_R1_C, COMMA), DIV_R2));
    stateMap.insert(state_value_type(state_token_key_type(DIV_R2, REGISTER), START));
    
    stateMap.insert(state_value_type(state_token_key_type(DIVU_R1, REGISTER), DIVU_R1_C));
    stateMap.insert(state_value_type(state_token_key_type(DIVU_R1_C, COMMA), DIVU_R2));
    stateMap.insert(state_value_type(state_token_key_type(DIVU_R2, REGISTER), START));
    
    stateMap.insert(state_value_type(state_token_key_type(LW_R1, REGISTER), LW_R1_C));
    stateMap.insert(state_value_type(state_token_key_type(LW_R1_C, COMMA), LW_R2I));
    stateMap.insert(state_value_type(state_token_key_type(LW_R2I, HEXINT), LW_LPAREN));
    stateMap.insert(state_value_type(state_token_key_type(LW_R2I, INT), LW_LPAREN));
    stateMap.insert(state_value_type(state_token_key_type(LW_LPAREN, LPAREN), LW_R3));
    stateMap.insert(state_value_type(state_token_key_type(LW_R3, REGISTER), LW_RPAREN));
    stateMap.insert(state_value_type(state_token_key_type(LW_RPAREN, RPAREN), START));
    
    stateMap.insert(state_value_type(state_token_key_type(SW_R1, REGISTER), SW_R1_C));
    stateMap.insert(state_value_type(state_token_key_type(SW_R1_C, COMMA), SW_R2I));
    stateMap.insert(state_value_type(state_token_key_type(SW_R2I, HEXINT), SW_LPAREN));
    stateMap.insert(state_value_type(state_token_key_type(SW_R2I, INT), SW_LPAREN));
    stateMap.insert(state_value_type(state_token_key_type(SW_LPAREN, LPAREN), SW_R3));
    stateMap.insert(state_value_type(state_token_key_type(SW_R3, REGISTER), SW_RPAREN));
    stateMap.insert(state_value_type(state_token_key_type(SW_RPAREN, RPAREN), START));
    ...
    try{
        ...
        string currentToken = "";
        int addressIncr = 4;
        int curAddress = 12; //MERL FILE STARTS AFTER HEADER
        int relocCount = 0;
        //****************************************************
        // PASS ONE:
        //****************************************************
        ...
        for(it = tokLines.begin(); it != tokLines.end(); ++it){
            ...
            for(it2 = it->begin(); it2 != it->end(); ++it2){
                ...
                //READ INTO ACCEPTING STATES:
                         ...
                         (MFHI_R1 == currentState) || (MFLO_R1 == currentState) || (MULT_R2 == currentState) ||
                         (MULTU_R2 == currentState) || (DIVU_R2 == currentState) || (DIV_R2 == currentState) ||
                         (LW_RPAREN == currentState) || (SW_RPAREN == currentState)){
                    string stateValue = stateLookup(stateMap, currentState, currentToken);
                    if (ERROR == stateValue) {
                        throw "ERROR: expected valid token but got " + currentToken;
                    }else if ((DOTWORD_READ == currentState) && (ID == currentToken)){
                        relocCount++;
                    }
        ...
        //OUTPUT MERL HEADER
        //****************************************************
        output_branch_type(0, 0, 2, BEQ_R3I);
        int merlSize = curAddress;
        merlSize += 8 * relocCount;
        output_word(merlSize);
        int endCode = curAddress;
        output_word(endCode);
        ...
        int registerFinal = 0;
        int sixteenBitInt = 0;
        curAddress = 12; //AFTER MERL FILE HEADER
        ...
        for (it = tokLines.begin(); it != tokLines.end(); ++it) {
            ...
            for (it2 = it->begin(); it2 != it->end(); ++it2) {
                ...
                //ACCEPTING
                    ...
                    if (ID == currentToken) {
                        ...
                        if (it != symbolTable.end()) {
                            word = it->second;
                            relocations.push_back(curAddress);
                        }else{
                ...
                //BNE_R1 || BEQ_R1 || DIV_R1 || DIVU_R1 || MULT_R1 || MULTU_R1
                         ...
                         || (DIV_R1 == currentState) || (DIVU_R1 == currentState) || (MULT_R1 == currentState) ||
                         (MULTU_R1 == currentState) || (LW_R1 == currentState) || (SW_R1 == currentState)){
                    string stateValue = stateLookup(stateMap, currentState, currentToken);
                ...
                //BNE_R2 || BEQ_R2 || LW_R3 || SW_R3
                         ...
                         || (LW_R3 == currentState) || (SW_R3 == currentState)){
                    string stateValue = stateLookup(stateMap, currentState, currentToken);
                    string token_value = (*it2)->getLexeme();
                    string register_value = token_value.substr(1, token_value.size());
                ...
                //STATE (store 16bit signed integer for later)
                //LW_R2I || SW_R2I
                else if ((LW_R2I == currentState) || (SW_R2I == currentState)){
                    string stateValue = stateLookup(stateMap, currentState, currentToken);
                    sixteenBitInt = (*it2)->toInt();
                    if (HEXINT == currentToken) {
                        isValid16BitUnsigned(sixteenBitInt);
                    }else{
                ...
                //JR_READ || JALR_READ || ADD_R3 || SUB_R3 || SLT_R3 || SLTU_R3 || DIV_R2 || DIVU_R2 || MULT_R2 ||
                //MULTU_R2 || LW_RPAREN || SW_RPAREN
                         ...
                         (MFHI_R1 == currentState) || (DIV_R2 == currentState) || (DIVU_R2 == currentState) ||
                         (MULTU_R2 == currentState) || (MULT_R2 == currentState)){
                    string stateValue = stateLookup(stateMap, currentState, currentToken);
                    string token_value = (*it2)->getLexeme();
                    string register_value = token_value.substr(1, token_value.size());
                    ...
                    }else if ((DIV_R2 == currentState) || (DIVU_R2 == currentState) || (MULTU_R2 == currentState) ||
                              (MULT_R2 == currentState)){
                        output_div_mult_type(register1, registerFinal, currentState);
                    }
                    currentState = stateValue;
                    register1 = 0;
                    register2 = 0;
                ...
                //STATES take in integer and output
                ...
                //ACCEPTING STATE (lw and sw cases) after closing parenthesis
                else if ((LW_RPAREN == currentState) || (SW_RPAREN == currentState)){
                    string stateValue = stateLookup(stateMap, currentState, currentToken);
                    output_lw_sw_type(register2, register1, sixteenBitInt, currentState);
                    currentState = stateValue;
                    register1 = 0;
                    register2 = 0;
                    sixteenBitInt = 0;
        ...
        //****************************************************
        //OUTPUT MERL REL TABLE
        //****************************************************
        vector<int>::iterator it3;
        for (it3 = relocations.begin(); it3 != relocations.end(); it3++) {
            output_word(1);
            output_word( *it3);
        }
